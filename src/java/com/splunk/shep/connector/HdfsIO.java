...
public class HdfsIO implements DataSink
{
	...
	public HdfsIO(String targetIP, String targetPort, String filePath) throws Exception
	{
		port = targetPort;
		ip = targetIP;
		path = filePath;
	...
	public void set(String filePath)
	{
		...
		try 
		{
			String tarURL = new String("hdfs://") + ip + ':' + port + path + System.currentTimeMillis();
			...
			e.printStackTrace();
			logger.error("Exception in setting Hadoop connection: " + e.toString());
		}
	}
	...
	public void close()
	{
		...
		try 
		{
			...
			e.printStackTrace();
			logger.error("Exception in closing Hadoop connection: " + e.toString());
		}
    }
	...
	private void deleteCurrentFile()
	{
		...
		try 
		{
			...
			e.printStackTrace();
			logger.error("Exception in deleting Hdfs file: " + path + " - " + e.toString());
		}
	}
	
	public void send(byte[] rawBytes, String sourceType, String source, String host, long time) throws Exception 
	{
	...
	public void write(byte[] rawBytes, String sourceType, String source, String host, long time) throws Exception 
	{
		String message = HdfsEvent.build(rawBytes, sourceType, source, host, time);
	...
	public void send(String data, String sourceType, String source, String host, long time) throws Exception
	{
		write(data, sourceType, source, host, time);
		checkFileSize();
	}
	
	public void write(String data, String sourceType, String source, String host, long time) throws Exception 
	{
	...
	public String read(String fileNamePath) throws Exception
	{
		...
		try 
		{
			...
			logger.error("IOException in reading hdfs file " + file + ": " + e.toString());
			throw(e);
		}
	}
	...
	public String read()
	{
		...
		try 
		{
			...
			e.printStackTrace();
			logger.error("IOException in displaying hdfs file " + path + ": " + e.toString());
		}
