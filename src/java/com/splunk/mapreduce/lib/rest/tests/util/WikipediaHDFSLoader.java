...
package com.splunk.mapreduce.lib.rest.tests.util;
...
public class WikipediaHDFSLoader {
	...
	/**
	 * This method is a test method to check whether the data was loaded correctly in to HDFS
	 * 
	 * @param args String hdfs file path
	 */
	...
	public static void main(String[] args) {
		if(args.length != 2) {
			System.err.println("Usage: Parser <url-to-wikipedia-bz2-file> <hdfsfilepath>");
			System.exit(-1);
		}
		try {
