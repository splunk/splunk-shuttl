...
public class EventEmitter implements DataSink
{
    ...
    public void run() throws Exception 
	{
		...
		final BufferedReader stdIn = new BufferedReader(new InputStreamReader(System.in, "US-ASCII"));
		String userInput;
	...
	public void send(byte[] rawBytes, String sourceType, String source, String host, long time) throws Exception 
	{
		...
		logger.debug("Sending event_host=" + host
				+ ", event_source=" + source
		...
		/*
		System.out.println("Sending event_host=" + host
						   + ", event_source=" + source
						   + ", event_sourcetype=" + sourceType
						   + ", event_time=" + time
						   + ", event_rawlen=" + rawBytes.length);  // */
	...
	public static void main(String[] args) throws IOException 
	{
		...
		{
			System.out.println("Please start with port (required) and ip (optional).\nUsage: EventEmitter <port-number> [<ip-address>] [<properties-file>]");
			return;
		}
