...
public class CsvGzipExporter extends CsvCompressedExporter {

	public CsvGzipExporter(CsvExporter csvExporter,
	...
	public static CsvGzipExporter create(CsvExporter csvExporter,
			LocalFileSystemPaths localFileSystemPaths) {
		return new CsvGzipExporter(csvExporter, new BucketFileCreator(
				BucketFormat.CSV_GZIP), new GetsBucketsExportFile(localFileSystemPaths));
	}
}
