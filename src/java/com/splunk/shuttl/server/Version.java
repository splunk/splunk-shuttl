...
public class Version {
	...
	public static void longUsage(PrintStream ps) {
		...
		ps.print(String.format("%1$s %2$-" + (m - OPT_VER.length()) + "s - %3$s",
				OPT_VER, " ", MSG_VER)
				+ "\n"
				+ String.format("%1$s %2$-" + (m - OPT_FULLVER.length()) + "s - %3$s",
						OPT_FULLVER, " ", MSG_FULLVER)
				+ "\n"
				+ String.format("%1$s %2$-" + (m - OPT_HELP.length()) + "s - %3$s",
						OPT_HELP, " ", MSG_HELP) + "\n");
	}
	...
	private static void usage(String classname, PrintStream ps) {
		...
		ps.println("\n\n"
				+ String.format("%1$s %2$-" + (m - OPT_VER.length()) + "s - %3$s",
						OPT_VER, " ", MSG_VER)
				+ "\n"
				+ String.format("%1$s %2$-" + (m - OPT_FULLVER.length()) + "s - %3$s",
						OPT_FULLVER, " ", MSG_FULLVER)
