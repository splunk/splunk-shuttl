...
public class SplunkServiceParameters {
	...
	public SplunkServiceParameters(String username, String password, String host,
			String mgmtPort) {
	...
	public SplunkServiceParameters(String username, String password, String host,
			String mgmtPort, String appContext) {
		this.username = username;
		this.password = password;
		this.host = host;
		this.mgmtPort = Integer.parseInt(mgmtPort);
	...
	public String toString() {
		return "SplunkParameters [username=" + username + ", password=" + password
				+ ", host=" + host + ", mgmtPort=" + mgmtPort + ", appContext="
				+ appContext + "]";
	}
