...
public class TUtilsEnvironment {
	...
	/**
	 * Clear the current environment. Should not be used outside the class or test
	 * class.
	 */
	...
	private static Map<String, String> getModifiableMap(Map<String, String> env,
			Class<?> cl) {
		try {
	...
	/**
	 * Contains it's own test class so that clearEnvironment can be truly private.
	 */
