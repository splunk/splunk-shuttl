...
public class LogFormatterTest {
	...
	public void did_validArguments_expectedOutput() {
		...
		assertTrue(
				...
				result
						.matches("did=\"didStuff\" happened=\"happenedStuff\" expected=\"expectedStuff\""));
	}
	...
	public void did_withAdditionalKeyValues_expectedOutput() {
		String result = did("didStuff", "happenedStuff", "expectedStuff", "btw",
				"200");
		assertTrue(
				assertFailedMessageStart + result,
				result
						.matches("did=\"didStuff\" happened=\"happenedStuff\" expected=\"expectedStuff\" btw=\"200\""));
	}
	...
	public void did_withAdditionalKeyValuesNoExpected_expectedOutput() {
		...
		assertTrue(assertFailedMessageStart + result,
				result
						.matches("did=\"didStuff\" happened=\"happenedStuff\" btw=\"200\""));
	}

	@Test(expectedExceptions = IllegalArgumentException.class)
	public void did_ilegalNumberOfArguments_illegalArgumentException() {
		did("didStuff", "happenedStuff", "expectedStuff", "more stuff");
	}
	...
	public void done_nonObjectArguments_expectedOutput() {
		...
		// Verify
		assertTrue(assertFailedMessageStart + result,
				result.matches("done=\"" + currentDate.toString() + "\" btw=\"200\""));
	}
