...
/**
 * {@link ShepArchiver} with path to archiver.xml configuration file.</br>
...
public class ShepArchiverForTests extends ShepArchiver {

    /**
     * @throws ShepMBeanException
     */
    public ShepArchiverForTests() throws ShepMBeanException {
	super();
    }
     ...
     * (non-Javadoc)
     * 
     * @see com.splunk.shep.server.mbeans.ShepArchiver#getArchiverConfXml()
     */
    @Override
