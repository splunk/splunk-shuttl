...
public class MBeanUtilsTest {
    ...
    MBeanServer mbs;
    Class<ShepArchiver> realClass;
    Class<ShepArchiverMBean> interfaceClass;

    @BeforeMethod
    public void setUp() throws MalformedObjectNameException,
	    NullPointerException {
	mbs = ManagementFactory.getPlatformMBeanServer();
	objectNameString = ShepArchiverMBean.OBJECT_NAME;
	objectName = new ObjectName(objectNameString);
	realClass = ShepArchiver.class;
	interfaceClass = ShepArchiverMBean.class;
    }
    ...
    public void getMBeanInstance_registeredMBean_getsInstance()
	    throws Exception {
	MBeanUtils.registerMBean(objectNameString, realClass);
	ShepArchiverMBean instance = MBeanUtils.getMBeanInstance(
